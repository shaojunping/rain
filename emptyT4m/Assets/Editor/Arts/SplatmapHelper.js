...
// @MenuItem("Artists Tools/Terrain splatmap tools/0 - Instructions - CLICK FIRST TO READ")
...
@MenuItem("Artists Tools/Terrain splatmap tools/1 - Save Selected Splatmap to PNG")
...
@MenuItem("Artists Tools/Terrain splatmap tools/2 - Turn PNG Back Into Splatmap Format")
static function Fix() {
...
// @MenuItem("Artists Tools/Terrain splatmap tools/3 - Replace Unity Terrain Splatmap With New PNG")
