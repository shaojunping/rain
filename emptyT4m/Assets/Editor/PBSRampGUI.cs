    ...
    class PBSRampGUI : ShaderGUI
{
	...
	private static class Styles
	{
        ...
        // 分离Alpha通道作为圆滑通道并额外增加调节选项
        public static GUIContent smoothMapText = new GUIContent("Smoothness (R)", "Smoothness Map");
        ...
        public static GUIContent rampMapText = new GUIContent("Ramp Map(RGB)", "Ramp Map");
		public static GUIContent orthoNormalizeText = new GUIContent("Orthonormalize", "Orthonormalize tangent base");
        public static GUIContent occlusionText = new GUIContent("Occlusion(G)", "Occlusion Map");
    ...
    //分离圆滑贴图
    MaterialProperty smoothMap = null;
    ...
    MaterialProperty rampOffset = null;
    MaterialProperty hColor = null;
	...
	public void FindProperties (MaterialProperty[] props)
	{
        ...
        rampOffset = FindProperty("_RampOffset", props);
        hColor = FindProperty("_HColor", props);
    ...
    {
        m_MaterialEditor.TexturePropertySingleLine(Styles.rampMapText, rampMap);
        if (rampMap.textureValue != null)
        {
            m_MaterialEditor.ColorProperty(hColor, hColor.displayName);
            m_MaterialEditor.ColorProperty(sColor, sColor.displayName);
            m_MaterialEditor.ShaderProperty(rampOffset, rampOffset.displayName);
        }
    }
