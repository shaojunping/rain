...
//#endif
        ...
        public VertexSegment GetVertices(int vcount, int icount)
        {
            ...
            var ret = new VertexSegment(VertexUsed - vcount, vcount, IndexUsed - icount, icount, this);
        ...
        public void LateUpdate()
        {
            ...
            if (ColorChanged)
            {
                TailMesh.colors = Colors;
            }

            if (IndiceChanged)
            {
                TailMesh.triangles = Indices;
            }
            ...
            else
            {
                ...
                Graphics.DrawMesh(TailMesh, Matrix4x4.identity, _material, _owner.gameObject.layer, null, 0, null, false,
                    false);
            }
        }
    }
