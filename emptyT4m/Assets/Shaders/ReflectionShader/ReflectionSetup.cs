...
{
    public enum reflectionTexSize
    {
        Low,//256
        High,//512
    }
    public reflectionTexSize quality = reflectionTexSize.Low;
    ...
    public int reflectionTextureSize
    {
        get
        {
            switch (quality)
            {
                case reflectionTexSize.High: return 512;
                case reflectionTexSize.Low: return 256;
            }
            return 0;
        }
    }
	...
	public void OnWillRenderObject()
	{
		...
		reflectionCamera.cullingMask = ~(1<<4) & reflectionMask.value; // never render water layer
	...
	private void CreateMirrorObjects( Camera currentCamera, out Camera reflectionCamera )
	{
        ...
        m_TextureSize =reflectionTextureSize;
